import { defaultMessageTypeRepository } from './messages/repository.js'
...
const message2 = defaultMessageTypeRepository.getFactory('blockOpened')({
  rawKwargs: { description: 'test' },
})
...
const message = defaultMessageTypeRepository.parse(
  "##teamcity[inspection line='123123.123' message='test' file='test' typeId='asdasd']"
)
// @ts-ignore
message.ansiPrint()
...
import { LinearStreamParser } from './parser/parser.js'
...
inputStream.pipe(linearStreamParser).on('data', (message: any) => {
